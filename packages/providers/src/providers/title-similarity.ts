...
/**
 * Conservative similarity for identity matching.
 *
 * Exact normalized titles score 1. Otherwise we use the stronger of token
 * Jaccard similarity and character trigram Dice similarity. Jaccard avoids the
 * old short-title problem where one shared word out of two scored 50%, while
 * trigrams retain tolerance for small spelling/transliteration differences.
 */
